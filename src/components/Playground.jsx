...
export default function Playground() {
  ...
  useEffect(() => {
    ...
    const update = () => {
      ...
      // Trigger Boss at 250 * Wave score threshold
  ...
  return (
    <section id="playground" className="py-16 px-4 max-w-4xl mx-auto text-center">
      ...
      <div className="rounded-3xl bg-slate-950 border-2 border-slate-800 p-3 sm:p-5 shadow-2xl relative overflow-hidden backdrop-blur-xl">
        ...
        <div className="mt-4 grid grid-cols-3 gap-2 sm:hidden font-mono text-xs">
          <button
            ...
            className="py-3 rounded-xl bg-slate-900 border border-slate-800 text-slate-200 active:bg-slate-800 text-center select-none"
          >
            ◀ LEFT
          </button>
          ...
          <button
            ...
            className="py-3 rounded-xl bg-orange-600/80 border border-orange-500 text-white font-bold active:bg-orange-600 text-center select-none"
          >
            🔥 FIRE
          </button>
